            ...
            <div class="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
                ...
                <div>
                    ...
                    <div aria-hidden="true" class="pointer-events-none lg:absolute lg:inset-y-0 lg:mx-auto lg:w-full lg:max-w-7xl">
                        ...
                        <NuxtLink to="/products" class="inline-block rounded-md border border-transparent bg-indigo-600 px-8 py-3 text-center font-medium text-white hover:bg-indigo-700">See our products</NuxtLink>
                    </div>
                </div>
            </div>
        </div>
